        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div>
                <button class="btn btn-warning mr-3" :disabled="disabledButton(todoDetail.status)" @click="updateTodo(todoDetail)">수정하기</button>
                <button class="btn btn-danger mr-3" :disabled="disabledButton(todoDetail.status)" @click="updateTodoStatus(todoDetail.id, 'DELETED')">삭제하기</button>
                <button class="btn btn-success" :disabled="disabledButton(todoDetail.status)" @click="updateTodoStatus(todoDetail.id, 'COMPLETED')">완료하기</button>
...
export default {
  ...
  methods: {
    ...
    disabledButton: function(status) {
      console.log(status)
